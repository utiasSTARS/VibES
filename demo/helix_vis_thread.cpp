...
//    int n_samples, cv::Mat &image, std::shared_ptr<Open3DVisualizer> vis,
//            int bin_col, int bin_w, int bin_row, int bin_h,
//            double process_noise, double measurement_noise, double target_omega,
//            double c_x,
//            double c_y,
